...
class Department(models.Model):
    name = models.CharField(max_length=100,blank=True, null=True,default= 'department_name')
    description = models.TextField(max_length=100,blank=True, null=True, default= 'description')
...
class Student(models.Model):
    ...
    course_program = models.CharField(max_length=20, null=True)
