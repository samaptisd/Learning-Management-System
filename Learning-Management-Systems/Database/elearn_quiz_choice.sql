...
CREATE TABLE `quiz_choice` (
  ...
  PRIMARY KEY (`id`),
  KEY `quiz_choice_question_id_6297ad3f_fk` (`question_id`),
  CONSTRAINT `quiz_choice_question_id_6297ad3f_fk` FOREIGN KEY (`question_id`) REFERENCES `quiz_mcquestion` (`question_ptr_id`)
...
-- Dump completed on 2025-06-24 14:43:50
