...
class Quiz(models.Model):
    # user = models.ForeignKey(settings.AUTH_USER_MODEL, related_name='quiz_user', on_delete=models.CASCADE)
    course = models.ForeignKey(Course, on_delete=models.CASCADE, null=True)
    title = models.CharField(verbose_name=_("Title"), max_length=100, blank=False)
    slug = models.SlugField(blank=True, unique=False,max_length=100)
...
class Progress(models.Model):
    ...
    def list_all_cat_scores(self):
        ...
        output = {}
        if self.score is not None and len(self.score) > len(score_before):
    ...
    def update_score(self, question, score_to_add=0, possible_to_add=0):
        ...
        if any([item is False for item in [score_to_add, possible_to_add, isinstance(score_to_add, str), isinstance(possible_to_add, str)]]):
        ...
        match = re.search(to_find, str(self.score), re.IGNORECASE)
...
class Sitting(models.Model):
    ...
    user_answers = models.TextField(max_length=1024,blank=True,default='{}', verbose_name=_("User Answers"))
    # user_answers = models.TextField(max_length=100000,default='{}',  verbose_name=_("User Answers"))
    ...
    def add_to_score(self, points):
        print(points)
        print(type(points))
        points = int(points)  # Convert points to an integer
    ...
    def check_if_passed(self):
        return self.get_percent_correct >= int(self.quiz.pass_mark)
