...
CREATE TABLE `app_semester` (
  ...
  PRIMARY KEY (`id`),
  KEY `app_semester_session_id_74165707_fk` (`session_id`),
  CONSTRAINT `app_semester_session_id_74165707_fk` FOREIGN KEY (`session_id`) REFERENCES `app_session` (`id`)
...
-- Dump completed on 2025-06-24 14:43:25
