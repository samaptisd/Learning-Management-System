...
CREATE TABLE `quiz_question_quiz` (
  ...
  KEY `quiz_question_quiz_quiz_id_eccb418d_fk` (`quiz_id`),
  CONSTRAINT `quiz_question_quiz_question_id_2b2637b3_fk` FOREIGN KEY (`question_id`) REFERENCES `quiz_question` (`id`),
  CONSTRAINT `quiz_question_quiz_quiz_id_eccb418d_fk` FOREIGN KEY (`quiz_id`) REFERENCES `quiz_quiz` (`id`)
...
-- Dump completed on 2025-06-24 14:44:09
